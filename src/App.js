...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route>
        <Route path='/w/:idWorkspace/pj/:project_id/data_source/:active' element={<PageImportEvent1/>} />
      </Route>
      <Route>
        <Route path='/w/:idWorkspace/pj/:project_id/data_preview/:collection_id/:active' element={<PageImportEvent2/>} />
      </Route>
      {/* <Route>
